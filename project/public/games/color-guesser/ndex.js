...
function handleCorrectGuess(clickedBox) {
    ...
    if (currentStreak > bestStreak) {
        ...
        saveBestStreak();
    //   Header Text Becomes Bold on New Best Streak
...
//  "Streak!" Message When Streak ≥ 3
    ...
    //  Show "First Win!" on First Correct Answer
    if (currentStreak === 1) {
...
function handleWrongGuess(clickedBox) {
    ...
    //  Wrong Box Shakes When Clicked
    clickedBox.classList.add('shake');
    setTimeout(() => {clickedBox.classList.remove('shake');},600);
